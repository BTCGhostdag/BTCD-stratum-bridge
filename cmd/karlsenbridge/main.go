...
import (
	...
	"github.com/BTCGhostdag/BTCD-stratum-bridge/src/BTCDstratum"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "BTCD", cfg.RPCServer, "address of the BTCD node, default `localhost:42110`")
	...
	log.Printf("\tBTCD:        %s", cfg.RPCServer)
	...
	if err := BTCDstratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
